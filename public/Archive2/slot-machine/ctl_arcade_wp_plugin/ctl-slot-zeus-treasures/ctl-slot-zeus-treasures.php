<?php
    /*
    Plugin Name: CTL Arcade - Slot Zeus Treasures
    Plugin URI: http://www.codethislab.com/
    Description: Slot Zeus Treasures for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlotZeusTreasures {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-zeus-treasures";
        private $_szPluginName              = "Slot Zeus Treasures";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "mythology, casino, gambling, html5 slot machine, instant win, money, poker, slot, slot machine, bonus, html5 slot game, sweepstakes, lottery";
    ...
    $g_oCTLArcadeSlotZeusTreasures =  new CTLArcadeSlotZeusTreasures();
