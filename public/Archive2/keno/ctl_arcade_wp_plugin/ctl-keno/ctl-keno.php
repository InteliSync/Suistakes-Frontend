<?php
    /*
    Plugin Name: CTL Arcade - Keno
    Plugin URI: http://www.codethislab.com/
    Description: Keno for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeKeno {
        ...
        private $_szPluginDir               = "ctl-keno";
        private $_szPluginName              = "Keno";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "	android game, bet, bingo, casino, casino games, chinese gambling games, chinese games, gambling game, instant win, iOS GAME, las vegas, lottery game, poker, slot machine, sweepstakes";
    ...
    $g_oCTLArcadeKeno =  new CTLArcadeKeno();