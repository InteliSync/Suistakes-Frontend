<?php
    /*
    Plugin Name: CTL Arcade - Slot Ultimate Soccer
    Plugin URI: http://www.codethislab.com/
    Description: Slot Ultimate Soccer for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlotUltimateSoccer{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-ultimate-soccer";
        private $_szPluginName              = "Slot Ultimate Soccer";
        private $_szAspectRatio             = "16:7";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "casino, casino game, soccer, gambling, html5 casino, instant win, football game, poker, slot, slot machine, videopoker,sweepstakes, lottery, soccer game, sport game";
    ...
    $g_oCTLArcadeSlotUltimateSoccer =  new CTLArcadeSlotUltimateSoccer();
